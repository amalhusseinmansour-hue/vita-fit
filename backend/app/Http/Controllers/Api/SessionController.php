...
class SessionController extends Controller
{
        ...
        $sessions = $query->orderBy('scheduled_at', 'desc')
            ...
            ->map(function ($session) {
                return [
                    ...
                    'meeting_platform' => $session->meeting_platform ?? 'zoom',
                    'meeting_link' => $session->meeting_link ?? $session->zoom_join_url,
                    'meeting_id' => $session->meeting_id ?? $session->zoom_meeting_id,
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'meeting_platform' => 'nullable|in:zoom,google_meet,other',
        ...
        $session = TrainingSession::create([
            ...
            'meeting_platform' => $request->meeting_platform ?? 'zoom',
    ...
    public function show($id)
    {
        ...
        return response()->json([
            ...
            'session' => [
                ...
                'meeting_link' => $session->meeting_link ?? $session->zoom_join_url,
                'meeting_id' => $session->meeting_id ?? $session->zoom_meeting_id,
                'meeting_password' => $session->meeting_password ?? $session->zoom_password,
                'zoom_join_url' => $session->zoom_join_url,
